...
Utilizamos los diferentes metodos que contiene la interfas Maps para asi aplicarlos en diferentes egercisios prpuestos en clase 
### Captura del código de implementación del ejercicio 4
...
public class Maps {
    ...
    public LinkedHashMap<String ,Integer>coLinkedHashMap(){
        System.out.println("Metodo linkeHashMap");
    ...
    public Map<String ,Integer>cTreeMap(){
         System.out.println("Metodo TreeMap");
